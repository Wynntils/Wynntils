...
public class TestGenericFunctions {
    ...
    public void testMathFunctions() {
        ...
        assertTemplateResult("{clamp(50;0;10)}", "10.0");
        assertTemplateResult("{safe_div(10;0;99)}", "99.0");
        assertTemplateResult("{map(15;10;20;0;100)}", "50.0");
        assertTemplateResult("{wrap(-1;0;10)}", "9.0");
    ...
    public void testConditions() {
        assertTemplateResult("{if(equals(3;3);add(1;1);add(2;2))}", "2.0");
        assertTemplateResult("{if(equals(2;3);add(1;1);add(2;2))}", "4.0");
