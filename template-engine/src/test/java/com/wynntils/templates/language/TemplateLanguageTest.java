...
class TemplateLanguageTest {
    ...
    void tokenizeTest1() {
        assertTokens(
                ...
                TemplateLexer.TokenType.ARGUMENTS_START,
                TemplateLexer.TokenType.NUMBER,
                TemplateLexer.TokenType.SEMICOLON,
                TemplateLexer.TokenType.NUMBER,
                TemplateLexer.TokenType.ARGUMENTS_END,
    ...
    void tokenizeTest3() {
        assertTokens(
                "{1.2;111.2356;1.7445;0.5;20;20000;10}",
                TemplateLexer.TokenType.TEMPLATE_START,
                TemplateLexer.TokenType.NUMBER,
                TemplateLexer.TokenType.SEMICOLON,
                TemplateLexer.TokenType.NUMBER,
