...
// luminance, so the geography stays legible while colour, names and icons are withheld. The
// vertex alpha is the fog strength: it blends between plain greyscale (0) and the full ramp (1),
// never back towards the original colours.
