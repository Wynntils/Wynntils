...
public class LootrunTaskNameOverlay extends TextOverlay {
    ...
    private static final String TEMPLATE = "{CONCAT("
            ...
            + "IF_STRING(STRING_EQUALS(lootrun_task_name(\"RAINBOW\"); \"\");\"\";CONCAT(if_string(lootrun_beacon_vibrant(\"rainbow\");\"§4V§ci§6b§er§aa§2n§bt \";\"\");\"§4R§ca§6i§en§ab§2o§bw§9: §f\"; lootrun_task_type(\"RAINBOW\");\" at \";lootrun_task_name(\"RAINBOW\"))))}";
    ...
    private static final String TEMPLATE_FORCE_COORDINATES = "{CONCAT("
            ...
            + "IF_STRING(STRING_EQUALS(lootrun_task_name(\"RAINBOW\"); \"\");\"\";CONCAT(if_string(lootrun_beacon_vibrant(\"rainbow\");\"§4V§ci§6b§er§aa§2n§bt \";\"\");\"§4R§ca§6i§en§ab§2o§bw§9: §f\"; lootrun_task_type(\"RAINBOW\");\" at \";\"[\"; str(x(lootrun_task_location(\"RAINBOW\"))); \", \"; str(y(lootrun_task_location(\"RAINBOW\"))); \", \"; str(z(lootrun_task_location(\"RAINBOW\"))); \"]\")))}";
