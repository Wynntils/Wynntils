...
public class LootrunTaskNameOverlay extends TextOverlay {
    ...
    private static final String TEMPLATE_FORCE_COORDINATES = "{CONCAT("
            ...
            + "IF_STRING(STRING_EQUALS(lootrun_task_name(\"RAINBOW\"); \"\");\"\";CONCAT(if_string(lootrun_beacon_vibrant(\"rainbow\");\"§#00f000ffVibrant \";\"\");\"§#00f000ffRainbow: §f\"; lootrun_task_type(\"RAINBOW\");\" at \";\"[\"; str(x(lootrun_task_location(\"RAINBOW\"))); \", \"; str(y(lootrun_task_location(\"RAINBOW\"))); \", \"; str(z(lootrun_task_location(\"RAINBOW\"))); \"]\")))}";
