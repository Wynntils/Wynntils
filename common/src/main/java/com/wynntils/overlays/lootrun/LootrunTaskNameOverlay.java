...
public class LootrunTaskNameOverlay extends TextOverlay {
    ...
    private static final String TEMPLATE = "{CONCAT("
            ...
            + "IF_STRING(STRING_EQUALS(lootrun_task_name(\"PINK\"); \"\");\"\";CONCAT(if_string(lootrun_beacon_vibrant(\"pink\");\"§#fd72b1ffVibrant \";\"\");\"§#fd72b1ffPink: \"; lootrun_task_type(\"PINK\");\" at \";lootrun_task_name(\"PINK\");\"\\n\"));"
    ...
    private static final String TEMPLATE_FORCE_COORDINATES = "{CONCAT("
            ...
            + "IF_STRING(STRING_EQUALS(lootrun_task_name(\"PINK\"); \"\");\"\";CONCAT(if_string(lootrun_beacon_vibrant(\"pink\");\"§#fd72b1ffVibrant \";\"\");\"§#fd72b1ffPink: \"; lootrun_task_type(\"PINK\");\" at \";\"[\"; str(x(lootrun_task_location(\"PINK\"))); \", \"; str(y(lootrun_task_location(\"PINK\"))); \", \"; str(z(lootrun_task_location(\"PINK\"))); \"]\";\"\\n\"));"
