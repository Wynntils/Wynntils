...
public class LootrunTaskNameOverlay extends TextOverlay {
    ...
    private static final String TEMPLATE = "{CONCAT("
            ...
            + "IF_STRING(STRING_EQUALS(lootrun_task_name(\"CRIMSON\"); \"\");\"\";CONCAT(if_string(lootrun_beacon_vibrant(\"crimson\");\"§#f01000ffVibrant \";\"\");\"§#f01000ffCrimson: \"; lootrun_task_type(\"CRIMSON\");\" at \";lootrun_task_name(\"CRIMSON\");\"\\n\"));"
    ...
    private static final String TEMPLATE_FORCE_COORDINATES = "{CONCAT("
            ...
            + "IF_STRING(STRING_EQUALS(lootrun_task_name(\"CRIMSON\"); \"\");\"\";CONCAT(if_string(lootrun_beacon_vibrant(\"crimson\");\"§#f01000ffVibrant \";\"\");\"§#f01000ffCrimson: \"; lootrun_task_type(\"CRIMSON\");\" at \";\"[\"; str(x(lootrun_task_location(\"CRIMSON\"))); \", \"; str(y(lootrun_task_location(\"CRIMSON\"))); \", \"; str(z(lootrun_task_location(\"CRIMSON\"))); \"]\";\"\\n\"));"
