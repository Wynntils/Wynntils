...
public class LootrunMissionsOverlay extends TextOverlay {
    private static final String TEMPLATE =
            "{if_string(string_equals(lootrun_state;\"NOT_RUNNING\");\"\";concat(\"§7Mission #1: §c\";lootrun_mission(0);\"\\n§7Mission #2: §c\";lootrun_mission(1);\"\\n§7Mission #3: §c\";lootrun_mission(2);\"\\n§7Mission #4: §c\";lootrun_mission(3)))}";
