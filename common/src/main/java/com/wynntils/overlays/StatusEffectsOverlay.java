            ...
            GuiGraphics guiGraphics, MultiBufferSource bufferSource, DeltaTracker deltaTracker, Window window) {
                FontRenderer.getInstance()
                        .renderTextsWithAlignment(
                                ...
                                List.of(
                                        new TextRenderTask(
                                                StyledText.fromString("§8⬤ §7 Purification 00:02"),
         textRenderSetting),
                                        new TextRenderTask(StyledText.fromString("§8⬤ §7 Exploding 01:12"),
         textRenderSetting),
                                        new TextRenderTask(StyledText.fromString("§8⬤ §7 Thorns 00:12"),
         textRenderSetting),
                                        new TextRenderTask(
                                                StyledText.fromString("§8⬤ §7 Soul Point Regen 00:12"),
         textRenderSetting)),
                                this.getWidth(),
                                this.getHeight(),
                                this.getRenderHorizontalAlignment(),
