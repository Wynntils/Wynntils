...
public class CombatFunctions {
    ...
    public static double areaDamageAverageFunction() {
    ...
    public static double totalAreaDamageFunction() {
    ...
    public static int killsPerMinuteFunction() {
    ...
    public static String lastSpellNameFunction() {
    ...
    public static int ticksSinceLastSpellFunction() {
    ...
    public static long timeSinceLastKillFunction() {
    ...
    public static int targetedMobDebuffValueFunction(double verticalDegrees, double range, String debuffName, double horizontalDegrees) {
    ...
    public static int debuffsInRadiusValueFunction(double radius, String debuffName) {
        DebuffType debuffType = DebuffType.fromName(debuffName);
        if (debuffType == null)
            return 0;
    ...
    public static String spellNameFromDirectionFunction(String clazz, String spellDirection) {
    ...
    public static String spellNameFromNumberFunction(String clazz, int spellNumber) {
