...
public class NpcDialogueOverlayFeature extends Feature {
    ...
    private List<StyledText2> currentDialogue = new ArrayList<>();
    ...
    private ScheduledFuture<?> scheduledSneakPress(List<StyledText2> msg) {
    ...
    public class NpcDialogueOverlay extends Overlay {
        ...
        private void renderDialogue(
                ...
                List<StyledText2> currentDialogue,
        ...
        public void render(PoseStack poseStack, MultiBufferSource bufferSource, float partialTicks, Window window) {
            ...
            LinkedList<StyledText2> allDialogues = new LinkedList<>(currentDialogue);
            confirmationlessDialogues.forEach(d -> {
                allDialogues.add(StyledText2.EMPTY);
    ...
    protected record ConfirmationlessDialogue(List<StyledText2> text, long removeTime) {}
}
