...
public class NpcDialoguesFeature extends Feature {
    @RegisterSubFeature
    private final Feature autoProgressDialogue = new AutoProgressDialogueFeature();
    ...
    protected void onConfigUpdate(Config<?> config) {
        updateSegmentVisibility(!isEnabled());
    }

    private void updateSegmentVisibility(boolean disabled) {
        Models.Dialogue.setHideSegments(disabled, !shouldDisplayOriginal.get(), hideFadeEffect.get());
    }
}
