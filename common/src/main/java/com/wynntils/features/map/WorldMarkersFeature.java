...
public class WorldMarkersFeature extends Feature {
    ...
    @Persisted
    private final Config<Float> iconRenderScale = new Config<>(1.0f);
    ...
    @Persisted
    private final Config<Float> screenMarginTop = new Config<>(40f);

    @Persisted
    private final Config<Float> screenMarginBottom = new Config<>(100f);

    @Persisted
    private final Config<Float> screenMarginSides = new Config<>(30f);

    @Persisted
    private final Config<Integer> maxMarkerDistance = new Config<>(5000);
