...
public class MinimapFeature extends Feature {
    ...
    public final KeyBind zoomIn =
            new KeyBind("Increase Minimap Zoom", GLFW.GLFW_KEY_EQUAL, false, () -> minimapOverlay.adjustZoomStep(1));

    @RegisterKeyBind
    public final KeyBind zoomOut =
            new KeyBind("Decrease Minimap Zoom", GLFW.GLFW_KEY_MINUS, false, () -> minimapOverlay.adjustZoomStep(-1));
}
