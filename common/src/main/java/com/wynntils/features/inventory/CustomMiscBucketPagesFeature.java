...
public class CustomMiscBucketPagesFeature extends Feature {
    ...
    private static final int MAX_MISC_BUCKET_PAGES = 10;
    ...
    private int lastPage = MAX_MISC_BUCKET_PAGES;
    ...
    public void onScreenInit(ScreenInitEvent e) {
        ...
        if (!Models.Container.isMiscBucketScreen(screen)) return;
    ...
    public void onContainerSetEvent(ContainerSetContentEvent.Post e) {
        ...
        if (Models.Container.isItemIndicatingLastBankPage(e.getItems().get(Models.Container.LAST_BANK_PAGE_SLOT))) {
            Models.Container.updateFinalMiscBucketPage(currentPage);
    ...
    protected void onConfigUpdate(ConfigHolder configHolder) {
        switch (configHolder.getFieldName()) {
            case "buttonOnePage",
                ...
                } else if ((int) configHolder.getValue() > MAX_MISC_BUCKET_PAGES) {
                    configHolder.setValue(MAX_MISC_BUCKET_PAGES);
                }
            }
        }
    }
