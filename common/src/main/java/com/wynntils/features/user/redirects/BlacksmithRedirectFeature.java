    ...
    public void onChat(ChatMessageReceivedEvent event) {
        ...
        if (matcher.matches()) {
            ...
            for (String fragment : parseable_message.split("§")) {
                ...
                if (fragment.equals("dYou sold me: ") || fragment.equals("dYou scrapped: ") || fragment.equals("d, ") || fragment.equals("d and ") || fragment.equals("d for a total of ") || fragment.equals("5Blacksmith: ")) {
                        continue;
            }
                ...
                if (fragment.matches("e\\d+")) {
                    ...
                    StringBuilder messageCounts = new StringBuilder();
                        for (ItemTier tier : ItemTier.values()) {
                            messageCounts.append('/' + tier.getChatFormatting().toString() + itemCounts.getOrDefault(tier, 0));
                    ...
                    if (parseable_message.split(" ")[2].equals("sold")) {
                        ...
                        sendableMessage.append(ChatFormatting.GREEN + fragment.replace("e", "") + EmeraldSymbols.EMERALDS + ChatFormatting.LIGHT_PURPLE + ".");
                    }
                    // Scrapping items for scrap
                    else {
                        sendableMessage.append(ChatFormatting.LIGHT_PURPLE + "Scrapped " + totalItemInteger + " ");
                        sendableMessage.append(messageCountsString);
                        sendableMessage.append(ChatFormatting.YELLOW + fragment.replace("e", "") + " scrap" + ChatFormatting.LIGHT_PURPLE + ".");
                    }
