...
public enum UrlId {
    ...
    DATA_STATIC_MAPDATA_COMBAT_LOCATIONS("dataStaticMapdataCombatLocations"),
    ...
    DATA_STATIC_MAPDATA_PLACES("dataStaticMapdataPlaces"),
    DATA_STATIC_SEASKIPPER_DESTINATIONS("dataStaticSeaskipperDestinations"),
    DATA_STATIC_MAPDATA_SERVICES("dataStaticMapdataServices"),
