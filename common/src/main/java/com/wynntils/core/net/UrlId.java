...
public enum UrlId {
    ...
    DATA_STATIC_ABILITIES_V2("dataStaticAbilitiesV2"),
    ...
    DATA_STATIC_ITEM_DISPLAY_MODEL_DATA("dataStaticItemDisplayModelData"),
    ...
    DATA_STATIC_SEASKIPPER_DESTINATION_AREAS("dataStaticSeaskipperDestinationAreas"),
    ...
    DATA_STATIC_SETS("dataStaticSets"),
