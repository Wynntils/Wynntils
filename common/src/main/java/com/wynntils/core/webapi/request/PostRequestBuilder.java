...
public class PostRequestBuilder extends RequestBuilder {
    ...
    public PostRequest build() {
        return new PostRequest(this.url, this.id, this.parallelGroup, this.handler, this.useCacheAsBackup, this.onError, this.headers, this.cacheFile, this.cacheValidator, this.timeout, writer);
    }
}
