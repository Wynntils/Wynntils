...
public class UpdateManager extends CoreManager {
    ...
    public static CompletableFuture<String> getLatestBuild() {
        ...
        RequestResponse response = ApiRequester.get(UrlManager.getUrl(UrlManager.API_ATHENA_UPDATE_CHECK), "update-check");
    ...
    public static CompletableFuture<UpdateResult> tryUpdate() {
        ...
        RequestResponse response = ApiRequester.get(UrlManager.getUrl(UrlManager.API_ATHENA_UPDATE_CHECK), "update-check-2");
        response.handleJsonObject(json -> {
