...
public class BeaconBeamToWorldMarkersUpfixer extends RenamedKeysUpfixer {
    private static final List<Pair<String, String>> RENAMED_KEYS =
            List.of(Pair.of("beaconBeamFeature.waypointBeamColor", "worldMarkersFeature.waypointBeamColor"));
