...
public class MobTotemTimerOverlayFeatureToBonusTotemTimerOverlayFeature extends RenamedPrefixesUpfixer {
    private static final List<Pair<String, String>> RENAMED_PREFIXES =
            List.of(Pair.of("mobTotemTimerOverlayFeature.", "bonusTotemTimerOverlayFeature."));
