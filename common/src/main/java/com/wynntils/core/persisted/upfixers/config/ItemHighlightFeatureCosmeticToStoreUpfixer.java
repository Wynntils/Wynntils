...
public class ItemHighlightFeatureCosmeticToStoreUpfixer extends RenamedKeysUpfixer {
    private static final List<Pair<String, String>> RENAMED_KEYS = List.of(Pair.of(
            "itemHighlightFeature.cosmeticHighlightEnabled", "customBankQuickJumpsFeature.storeHighlightEnabled"));
