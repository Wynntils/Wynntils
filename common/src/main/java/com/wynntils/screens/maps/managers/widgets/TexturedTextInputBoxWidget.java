...
public class TexturedTextInputBoxWidget extends TextInputBoxWidget {
    private static final Component DEFAULT_TEXT = Component.translatable("screens.wynntils.map.managers.categoryManager.TexturedTextInputBoxWidget.default");
    ...
    public TexturedTextInputBoxWidget(int x, int y, int width, int height, Consumer<String> onUpdateConsumer, TextboxScreen textboxScreen, Mode mode) {
        super(x, y, width, height, Component.literal("Textured Text Input Box Widget"), wrapConsumer(mode, onUpdateConsumer), textboxScreen);
        this.mode = mode;
    }
