...
public final class PoiManagementScreen extends WynntilsScreen {
        ...
        this.addRenderableWidget(
                importButton = new Button.Builder(
                        ...
                        .tooltip(Tooltip.create(
                                Component.translatable("screens.wynntils.poiManagementGui.import.tooltip")))
                        .build());
    ...
    private void importFromClipboard() {
        ...
        importButton.setTooltip(Tooltip.create(
                Component.translatable("screens.wynntils.poiManagementGui.import.success", customPois.length)));
    }
