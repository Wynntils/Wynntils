...
public final class PoiCreationScreen extends WynntilsScreen implements TextboxScreen {
    ...
    public void doRender(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        FontRenderer.getInstance()
                .renderText(
                        poseStack,
                        StyledText.of(I18n.get("screens.wynntils.poiCreation.waypointName") + ":"),
                        this.width / 2f - 100,
                        this.height / 2f - 60,
                        CommonColors.WHITE,
        ...
        FontRenderer.getInstance()
                .renderText(
                        poseStack,
                        StyledText.of(I18n.get("screens.wynntils.poiCreation.coordinates") + ":"),
                        this.width / 2f - 100,
                        this.height / 2f - 15,
                        CommonColors.WHITE,
                        HorizontalAlignment.LEFT,
        ...
        FontRenderer.getInstance()
                .renderText(
                        poseStack,
                        StyledText.of(I18n.get("screens.wynntils.poiCreation.icon") + ":"),
                        this.width / 2f - 100,
                        this.height / 2f + 30,
                        CommonColors.WHITE,
                        HorizontalAlignment.LEFT,
        ...
        FontRenderer.getInstance()
                .renderText(
                        poseStack,
                        StyledText.of(I18n.get("screens.wynntils.poiCreation.color") + ":"),
                        this.width / 2f - 10,
                        this.height / 2f + 30,
                        CommonColors.WHITE,
                        HorizontalAlignment.LEFT,
        ...
        FontRenderer.getInstance()
                .renderText(
                        poseStack,
                        StyledText.of(I18n.get("screens.wynntils.poiCreation.visibility") + ":"),
                        this.width / 2f - 100,
                        this.height / 2f + 80,
                        CommonColors.WHITE,
                        HorizontalAlignment.LEFT,
        ...
        FontRenderer.getInstance()
                .renderAlignedTextInBox(
                        poseStack,
                        StyledText.of(I18n.get(selectedVisiblity.getTranslationKey())),
                        this.width / 2f - 100,
                        this.width / 2f + 100,
                        this.height / 2f + 90,
                        this.height / 2f + 110,
