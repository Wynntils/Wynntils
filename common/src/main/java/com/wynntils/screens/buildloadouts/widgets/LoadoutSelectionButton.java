...
public class LoadoutSelectionButton extends AbstractButton implements TooltipProvider {
    ...
    public LoadoutSelectionButton(StyledText text, Texture icon, MenuCategory menuCategory, int x, int y, BuildLoadoutsScreen parent) {
