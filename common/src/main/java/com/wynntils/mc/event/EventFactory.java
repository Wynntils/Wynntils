...
public class EventFactory {
    public static void onScreenCreated(
        ...
        if (screen instanceof TitleScreen titleScreen) {
            WynntilsMod.eventBus.postEvent(new TitleScreenInitEvent(titleScreen, buttons, addButton));
    ...
    public static void onInventoryRender(
        ...
        WynntilsMod.eventBus.postEvent(new InventoryRenderEvent(screen, poseStack, mouseX, mouseY, partialTicks, hoveredSlot));
    }
