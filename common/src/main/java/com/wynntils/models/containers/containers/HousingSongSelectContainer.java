...
public class HousingSongSelectContainer extends Container implements SearchableContainerProperty {
    private static final Pattern TITLE_PATTERN = Pattern.compile("Select a Song");
    ...
    public HousingSongSelectContainer() {
        super(TITLE_PATTERN);
    }
