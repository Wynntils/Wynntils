...
public class RewardsModel extends Model {
    ...
    public ItemAnnotation fromCharmItemStack(ItemStack itemStack, StyledText2 name, String displayName, String type) {
    ...
    public static TomeItem fromTomeItemStack(
            ItemStack itemStack, StyledText2 name, String displayName, TomeType tomeType, String tier, String variant) {
