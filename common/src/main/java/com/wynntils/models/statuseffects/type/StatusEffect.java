...
public class StatusEffect {
    ...
    public StatusEffect(CodedString name, CodedString displayedTime, CodedString prefix) {
        ...
        if (prefix.endsWith(" ") || prefix.endsWith(" §7")) {
            this.fullName = CodedString.concat(prefix, name, CodedString.fromString(" "), displayedTime);
        } else {
            this.fullName = CodedString.concat(
                    prefix, CodedString.fromString(" "), name, CodedString.fromString(" "), displayedTime);
        }
    }
