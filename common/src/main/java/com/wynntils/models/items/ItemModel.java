...
import com.wynntils.models.items.annotators.gui.ArchetypeAnnotator;
import com.wynntils.models.items.annotators.gui.ContentAnnotator;
...
public class ItemModel extends Model {
    public ItemModel(
        ...
        Handlers.Item.registerAnnotator(new ArchetypeAnnotator());
        Handlers.Item.registerAnnotator(new ContentAnnotator());
