...
public class FunctionCommand extends Command {
    ...
    //        } else {
    //            paginatedFunctions = functions.subList(fromIndex, Math.min(fromIndex + LIST_PAGE_LIMIT,
    // functions.size()));
    //        }
    //
    ...
    //                        .withStyle(style ->
    //                                style.withHoverEvent(new HoverEvent.ShowText(Component.literal("Go to next
    // page")))));
    //
    ...
    //        result.append(
    //                Managers.Function.getSimpleValueString(function, argument.getString(), ChatFormatting.YELLOW,
    // true));
