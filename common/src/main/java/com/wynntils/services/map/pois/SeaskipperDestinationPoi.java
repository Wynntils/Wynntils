...
public class SeaskipperDestinationPoi implements Poi {
    ...
    private void renderPoi(
        ...
        final int renderWidth = (int) (width * mapZoom);
        final int renderHeight = (int) (height * mapZoom);
        final int actualRenderX = (int) (renderX - renderWidth / 2f);
        final int actualRenderZ = (int) (renderY - renderHeight / 2f);
