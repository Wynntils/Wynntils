...
public class PoiService extends Service {
    ...
    private void loadCaves() {
        ...
        //            profiles.forEach(
        //                    profile -> CombatListProvider.registerFeature(profile.location, CombatKind.CAVES,
        // profile.name));
        //        });
    }
    ...
    private void loadPlaces() {
        ...
        //                // PlaceListProvider.registerFeatures(label);
        //            }
        //        });
    }
    ...
    private void loadCombat() {
        ...
        //                        // CombatListProvider.registerFeature(new Location(profile.coordinates), kind,
        // profile.name);
        //                    }
        //                } else {
