...
public class StringStatFilterFactory implements StatFilterFactory<StringStatFilterFactory.StringStatFilter> {
    ...
    public static final class StringStatFilter implements StatFilter<String> {
        ...
        public boolean matches(String value) {
            return strict
                    ? value.equalsIgnoreCase(searchLiteral)
                    : StringUtils.containsIgnoreCase(value, searchLiteral);
        }
    }
}
