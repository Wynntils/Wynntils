...
public class ItemProfilesManager extends CoreManager {
    ...
    private static void tryLoadItemGuesses() {
        DownloadableResource dl =
                Downloader.download(Reference.URLs.getUrl(Reference.URLs.ITEM_GUESSES), "item_guesses.json", "item_guesses");
    ...
    private static void tryLoadItemList() {
        DownloadableResource dl =
                Downloader.download(Reference.URLs.getUrl(Reference.URLs.ATHENA_ITEM_LIST), "item_list.json", "item_list");
        dl.handleJsonObject(json -> {
    ...
    private static void tryLoadIngredientList() {
        DownloadableResource dl =
                Downloader.download(Reference.URLs.getUrl(Reference.URLs.ATHENA_INGREDIENT_LIST), "ingredient_list.json", "ingredientList");
        dl.handleJsonObject(json -> {
            Type hashmapType = new TypeToken<HashMap<String, String>>() {}.getType();
