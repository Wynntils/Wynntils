...
public final class BufferedRenderUtils {
    public static void drawLine(
        ...
        if (x1 == x2) {
            ...
            //            buffer.addVertex(matrix, x1 - halfWidth, y1, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
            //            buffer.addVertex(matrix, x2 - halfWidth, y2, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
            //            buffer.addVertex(matrix, x1 + halfWidth, y1, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
            //            buffer.addVertex(matrix, x2 + halfWidth, y2, z).setColor(color.r(), color.g(), color.b(),
            ...
            //            buffer.addVertex(matrix, x1, y1 - halfWidth, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
            //            buffer.addVertex(matrix, x1, y1 + halfWidth, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
            //            buffer.addVertex(matrix, x2, y2 - halfWidth, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
            //            buffer.addVertex(matrix, x2, y2 + halfWidth, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
    ...
    public static void drawRect(
        ...
        //        buffer.addVertex(matrix, x + width, y + height, z).setColor(color.r(), color.g(), color.b(),
        // color.a());
    ...
    public static void drawMulticoloredRect(
        ...
        for (int i = 0; i < colors.size(); i++) {
            ...
            // bottom left
            //            buffer.addVertex(matrix, leftX, y + height, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
            // bottom right
            //            buffer.addVertex(matrix, centerX, y + height, z).setColor(color.r(), color.g(), color.b(),
            // color.a());
            // top right
