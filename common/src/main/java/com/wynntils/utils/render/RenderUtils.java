...
public final class RenderUtils {
    ...
    public static void drawTexturedRect(
            GuiGraphics guiGraphics, Texture texture, float x, float y, int uOffset, int vOffset, int u, int v) {
        drawTexturedRect(
                guiGraphics,
                texture,
                CustomColor.NONE,
    ...
    public static void drawScalingTexturedRect(
        ...
        drawScalingTexturedRect(
                guiGraphics, texture.resource(), color, x, y, width, height, texture.width(), texture.height());
    }

    public static void drawScalingTexturedRect(
            GuiGraphics guiGraphics, Texture texture, float x, float y, float width, float height) {
        drawScalingTexturedRect(
                guiGraphics, texture.resource(), x, y, width, height, texture.width(), texture.height());
    }
    ...
    public static void drawHoverableTexturedRect(
        ...
        int uOffset = (hovered && dir == RenderDirection.HORIZONTAL ? textureWidth / 2 : 0);
        int vOffset = (hovered && dir == RenderDirection.VERTICAL ? textureHeight / 2 : 0);
    ...
    public static void drawScalingHoverableTexturedRect(
        ...
        int uOffset = (hovered && dir == RenderDirection.HORIZONTAL ? regionWidth : 0);
        int vOffset = (hovered && dir == RenderDirection.VERTICAL ? regionHeight : 0);
    ...
    public static void drawProgressBarForeground(
        ...
        if (progress > 0.0f) {
            ...
            float texFilled = texWidth * progress;

            x2 = x1 + filled;
            textureX2 = (int) (textureX1 + texFilled);
        } else {
            float filled = width * (-progress);
            float texFilled = texWidth * (-progress);

            x1 = x2 - filled;
            textureX1 = (int) (textureX2 - texFilled);
        }
    ...
    public static void renderCustomNametag(
        ...
        if (d <= 4096.0) {
            ...
            if (!sneaking) {
                //                font.drawInBatch(
                //                        nametag, xOffset, 0f, -1, false, matrix4f, buffer, Font.DisplayMode.NORMAL, 0,
                // packedLight);
            }
    ...
    public static void createRectMask(GuiGraphics guiGraphics, float x, float y, float width, float height) {
        // TODO: Port to 1.21.10
        GL11.glEnable(GL11.GL_STENCIL_TEST);
        ...
        drawRect(guiGraphics, CommonColors.WHITE, x, y, width, height);
