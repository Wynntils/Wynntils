...
public enum Texture {
    ...
    CHARM_OF_TWILIGHT("ability_cooldowns/charm_of_twilight.png", 18, 18),
    ...
    COUNTER("ability_cooldowns/counter.png", 18, 18),
    ...
    INTOXICATING_BLOOD("ability_cooldowns/intoxicating_blood.png", 18, 18),
    ...
    RESTRAINTS("ability_cooldowns/restraints.png", 18, 18),
    ...
    SATSUJIN("ability_cooldowns/satsujin.png", 18, 18),
    ...
    SNIFFER_DOG("ability_cooldowns/sniffer_dog.png", 18, 18),
    SOUL_SIPHON("ability_cooldowns/soul_siphon.png", 18, 18),
    SUNFLARE("ability_cooldowns/sunflare.png", 18, 18),
    TRIBAL_CHANTS("ability_cooldowns/tribal_chants.png", 18, 18),
