...
public enum Texture {
    ...
    BACK_ARROW("icons/generic_offset/back_arrow_icon_offset.png", 32, 9),
    BACKWARD_ARROW("icons/generic_offset/backward_arrow_icon_offset.png", 36, 10),
    FORWARD_ARROW("icons/generic_offset/forward_arrow_icon_offset.png", 36, 10),
    ...
    SORT_ALPHABETICALLY("icons/generic_offset/sort_alphabetical_icon_offset.png", 23, 46),
    SORT_DISTANCE("icons/generic_offset/sort_distance_icon_offset.png", 23, 46),
    SORT_LEVEL("icons/generic_offset/sort_level_icon_offset.png", 23, 46),
    // Map
