...
public enum Texture {
    ...
    OVERCHARGE("ability_cooldowns/overcharge.png", 18, 18),
    ...
    STRIDES_OF_HERESY("ability_cooldowns/strides_of_heresy.png", 18, 18),
    ...
    WARNING("icons/generic/warning.png", 16, 16),
