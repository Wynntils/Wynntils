...
public enum Texture {
    ...
    BUILD_LOADOUTS_MENU_RIBBON("build_loadouts/menu_ribbon.png", 78, 20, 20, 20, 10, 10),
    BUILD_LOADOUTS_SCROLL_LIST_TOP_BUTTON("build_loadouts/scroll_list_top_button.png", 40, 20, 13, 13, 10, 2),
