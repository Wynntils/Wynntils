...
public class CustomColor {
    ...
    public static CustomColor fromTextFormatting(ChatFormatting textFormatting) {
        return switch (textFormatting) {
            case BLACK -> new CustomColor(0, 0, 0);
            case DARK_BLUE -> new CustomColor(0, 0, 170);
            case DARK_GREEN -> new CustomColor(0, 170, 0);
            case DARK_AQUA -> new CustomColor(0, 170, 170);
            case DARK_RED -> new CustomColor(170, 0, 0);
            case DARK_PURPLE -> new CustomColor(170, 0, 170);
            case GOLD -> new CustomColor(255, 170, 0);
            case GRAY -> new CustomColor(170, 170, 170);
            case DARK_GRAY -> new CustomColor(85, 85, 85);
            case BLUE -> new CustomColor(85, 85, 255);
            case GREEN -> new CustomColor(85, 255, 85);
            case AQUA -> new CustomColor(85, 255, 255);
            case RED -> new CustomColor(255, 85, 85);
            case LIGHT_PURPLE -> new CustomColor(255, 85, 255);
            case YELLOW -> new CustomColor(255, 255, 85);
            case WHITE -> new CustomColor(255, 255, 255);
            default -> null;
        };
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof CustomColor c) {
